...
public class PartitionInfo {
    ...
    private final Node leader;              // 分区的 leader 结点
    private final Node[] replicas;          // 分区的所有副本结点
    private final Node[] inSyncReplicas;    // In-sync 的副本结点
    private final Node[] offlineReplicas;   // Offline 的副本结点
